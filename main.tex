...
\title{Bruhat-Tits Study Group}
%\author{Albert Lopez Bruch}

\begin{document}
	\maketitle
	\pagenumbering{arabic}
	\section{Introductory Talk}
    \input{introductory_talk.tex}

    \newpage
    \section{Week 4: Chevalley basis and Chevalley groups}
    \input{week4_talk.tex}
